...
//***********************************************************************************************************
    ...
    public Car getById (int id) { // id ye göre car cagır
        Car obj = null;
...
//***********************************************************************************************************
        //içine custom bi query yazdııgımda hepsin getirdigim metot
    public ArrayList<Car> findAll () {
        return this.selectByQuery("SELECT * FROM public.car ORDER BY car_id ASC");
    }
//***********************************************************************************************************
    //select olarka verdiğim query i bana geri araç listesi olarak veriyor
...
//***********************************************************************************************************
    ...
    // resultsetten gelen verileri car entittilere eşleştirmek için. heryerde yazılması gerekiyor
    public Car match (ResultSet rs) throws SQLException {
        ...
        car.setModel(this.modelDao.getById(car.getModel_id())); // modeldao da aldık veritabanında geldiği için
