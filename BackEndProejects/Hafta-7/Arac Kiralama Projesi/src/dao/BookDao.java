...
//*****************************************************************************************************************
    ...
    public boolean save (Book book) {
        ...
        try {
            ...
            pr.setDate(6, Date.valueOf(book.getStrt_date()));  //local date i içerde date sınıfının
            pr.setDate(7, Date.valueOf(book.getFnsh_date())); // valueof nesnesine attık. uygun format için
...
//*****************************************************************************************************************
//2023-10-15 formatını 15/10/2023 formatına ceviriyoruz
    public Book match (ResultSet rs) throws SQLException {
        ...
        //cardao dan arabamın id sine göre car nesnemi olusturuyorum
