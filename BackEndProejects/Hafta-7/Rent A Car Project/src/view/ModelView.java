...
public class ModelView extends Layout{
    ...
    public ModelView(Model model) {
        ...
        //yeni bi combobox eklemek için set model kullanmalıyım
        //  this.cmb_brand.setModel(new DefaultComboBoxModel());
        //alttaki veritabanından gelmiyor daha koaly (enum)
        ...
        //buraya kadar combolara aldık. şimdi kaydedicez
