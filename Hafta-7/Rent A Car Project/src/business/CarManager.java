...
public class CarManager {
    ...
    public ArrayList<Object[]> getForTable (int size, ArrayList<Car> cars) {
        ...
        return this.carDao.delete(id);
            ...
            //sonradan eklenen tarih aralıkları sorgusu in alttaki
            ...
            if (gear != null ) {
             ...
             String joinStr = String.join(" AND " , joinWhere);
                ...
                //sonradan eklenen tarih aralıkları için
                ArrayList<Car> searchedList = this.carDao.selectByQuery(query);
                ...
                ArrayList<Book> bookList = this.bookDao.selectByQuery(bookQuery); // arraylist dön
                ...
                //listmein içerisindeyse sil car (lambda array içinde) varsa bnm bussy listimin içinde seçtiğim araç
                searchedList.removeIf(car -> busyCarId.contains(car.getId()));
